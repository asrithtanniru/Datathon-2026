  ...
  return (
    <section className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 lg:pt-20 pb-16">
      <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
        {/* Left Content */}
        <motion.div className="max-w-2xl" variants={containerVars} initial="hidden" animate="show">
          <motion.h1 variants={itemVars} className="text-5xl lg:text-7xl font-bold tracking-tight text-slate-900 leading-[1.1] mb-6 font-heading">
            The leading AI-powered Real Estate marketplace
          </motion.h1>
          <motion.p variants={itemVars} className="text-lg lg:text-xl text-slate-600 mb-10 leading-relaxed">
          ...
          >
            ...
            />
            <button type="submit" className="ml-2 whitespace-nowrap bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-full font-medium transition-colors shadow-sm">
              Find Homes
            </button>
          </motion.form>
        ...
        <div className="relative w-full h-[600px] lg:h-[700px] flex justify-center lg:justify-end pr-0 lg:pr-8 mt-10 lg:mt-0">
          ...
          >
            ...
            <Image src="https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?q=80&w=2075&auto=format&fit=crop" alt="Beautiful home exterior" fill className="object-cover" priority />
          </motion.div>

          {/* Floating Cards */}
          <motion.div variants={badgeVars} initial="hidden" animate="show" className="absolute left-0 lg:-left-12 top-1/2 -translate-y-1/2 glass flex items-center gap-4 p-4 rounded-2xl z-20 w-48">
          ...
          <motion.div variants={badgeVars} initial="hidden" animate="show" className="absolute right-0 lg:-right-8 bottom-32 glass flex items-center gap-4 p-4 rounded-2xl z-20 w-48 shadow-lg">
            <div className="w-12 h-12 rounded-full overflow-hidden relative shrink-0 border-2 border-white shadow-sm">
