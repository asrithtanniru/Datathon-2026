...
export default function PropertyCard({ type, title, guests, bedrooms, price, rating, imageUrl }: PropertyCardProps) {
  return (
    <div className="group bg-white rounded-[24px] border border-slate-100 overflow-hidden hover:shadow-xl transition-all duration-300">
      ...
      <div className="p-5">
        ...
        <h3 className="text-slate-900 font-bold text-[17px] leading-tight mb-2 line-clamp-2">
          {title}
        </h3>
